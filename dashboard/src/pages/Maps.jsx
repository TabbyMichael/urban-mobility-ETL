  ...
  return (
    <div>
      ...
      <div className="card">
        ...
        <FullScreenChart title="Pickup Hotspots Map">
        ...
        {selectedZone && (
          <div className="card" style={{ marginTop: '1rem' }}>
            ...
            <p>Trips: {formatNumber(selectedZone.trips)}</p>
            <p>Congestion Level: {selectedZone.congestion}%</p>
          </div>
        )}
      </div>
      ...
      <div className="analytics-grid">
        <div className="card">
          ...
          <FullScreenChart title="Congestion Levels by Zone">
        ...
        <div className="card">
          ...
          <FullScreenChart title="Zone Congestion Distribution">
            <div className="chart-container">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie
      ...
      <div className="card">
        ...
        <FullScreenChart title="Real-time Traffic Flow">
          <div className="chart-container">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={[
